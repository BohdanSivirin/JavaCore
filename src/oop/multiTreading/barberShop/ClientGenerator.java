...
public class ClientGenerator extends Thread {
    ...
    public void getStatistics() {
        try {
            System.out.println(Thread.currentThread().getName() + " Statistics >> all generated clients: " + allGeneratedClientsAmount.get() + "\n");
    ...
    public void run() {
        while (true) {
            try {
               ...
               // System.out.println(Thread.currentThread().getName() + " Check clients.size is 0 -> " + clients.size());
                int generatedClients = new Random().nextInt(1, 4);
                System.out.println(Thread.currentThread().getName() + "Generator # " + currentThread().getName() + " generate number of clients: " + generatedClients + "\n");
                ...
                System.out.println(Thread.currentThread().getName() + "Value >> allGeneratedClientsAmount [before addAndGet(generatedClients)] : " + allGeneratedClientsAmount + "\n");
                allGeneratedClientsAmount.addAndGet(generatedClients);
                System.out.println(Thread.currentThread().getName() + "Value >> allGeneratedClientsAmount [after addAndGet(generatedClients)] : " + allGeneratedClientsAmount + "\n");
