...
public class Main {
    public static void main(String[] args) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("historyWaitNotify.txt"))) {
            ...
            Client mark = new Client(writer, "Serhei", shop);
            Client ivan = new Client(writer, "Nataly", shop);
            Client orest = new Client(writer, "Bohdan", shop);
